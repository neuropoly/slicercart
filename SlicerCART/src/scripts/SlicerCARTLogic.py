...
class SlicerCARTLogic(ScriptedLoadableModuleLogic):
    ...
    def __init__(self):
        """
        Called when the logic class is instantiated. Can be used for
    ...
    def process(self,
        ...
        :param imageThreshold: values above/below this threshold will be set
        to 0
        :param invert: if True then values above the threshold will be set to
        0, otherwise values below are set to 0
        ...
        # We don't need the CLI module node anymore, remove it to not clutter
        # the scene with it
